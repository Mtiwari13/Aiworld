...
$ai_blog_blog_container = get_theme_mod('ai_blog_blog_container', 'container-fluid');
...
<div class="<?php echo esc_attr($ai_blog_blog_container); ?> mt-5 mb-5 pt-5 pb-5">
	<div class="row">
		...
		<div class="<?php echo esc_attr($ai_blog_blog_column); ?>">
			<main id="primary" class="site-main">
				...
				while (have_posts()) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'ai-blog') . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'ai-blog') . '</span> <span class="nav-title">%title</span>',
						)
					);
